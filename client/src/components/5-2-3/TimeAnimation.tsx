...
export const TimeAnimation: React.FC<TimeAnimationProps> = ({ isAnimating, visible, className = '' }) => {
  ...
  return (
    <div className={`absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 ${className}`}>
      <style
      ...
      <CrayonTextBox bg='rgba(255, 255, 255, 30)' color='rgba(255, 255, 255, 0)' textcolor='#000000' className='p-4' animated={true}>
