...
const activityGuideSlides: ActivityGuideSlide[] = [
  {
    id: 'slide1',
    image: '/img/guide/5-2-1/guide1.jpeg',
    audioPath: '/sounds/5-2-1/intro/5-2-1-Intro-1.MP3',
  },
  {
    id: 'slide2',
    image: '/img/guide/5-2-1/guide2.jpeg',
    audioPath: '/sounds/5-2-1/intro/5-2-1-Intro-2.MP3',
  },
  {
    id: 'slide3',
    image: '/img/guide/5-2-1/guide3.jpeg',
    audioPath: '/sounds/5-2-1/intro/5-2-1-Intro-3.MP3',
  },
  {
    id: 'slide4',
                ...
                {slides.map((_, index) => (
                  <div
                    ...
                    className={`w-2 h-2 rounded-full mx-2 transition-all duration-300 ${
                      index === currentSlide
                        ? 'bg-[#9B1CDF] shadow-[0_0_8px_rgba(82,174,170,0.6)] scale-125'
                        : 'bg-gray-300 '
                    }`}
                  />
                ))}
