...
import AudioManager from '../6-2-2/AudioManager'
...
const activityGuideSlides: ActivityGuideSlide[] = [
  {
    id: 'slide1',
    image: '/img/guide/6-2-2/guide1.jpeg',
    audioPath: '/sounds/6-2-2/intro/6-2-2-Intro-1.MP3',
  },
  {
    id: 'slide2',
    image: '/img/guide/6-2-2/guide2.jpeg',
    audioPath: '/sounds/6-2-2/intro/6-2-2-Intro-2.MP3',
  },
  {
    id: 'slide3',
    image: '/img/guide/6-2-2/guide3.jpeg',
    audioPath: '/sounds/6-2-2/intro/6-2-2-Intro-3.MP3',
  },
  {
    id: 'slide4',
    image: '/img/guide/6-2-2/guide4.jpeg',
    audioPath: '/sounds/6-2-2/intro/6-2-2-Intro-4.MP3',
  },
  {
    id: 'slide5',
    image: '/img/guide/6-2-2/guide5.jpeg',
    audioPath: '/sounds/6-2-2/intro/6-2-2-Intro-5.MP3',
  },
  {
    id: 'slide6',
