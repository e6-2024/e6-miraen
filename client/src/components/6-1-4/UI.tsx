...
const seasonExplain = {
  summer: {
    text: '겨울철(동지경), 자정(밤 12 시경)에 남쪽 하늘을 바라보면 겨울철 대표적인 별자리인 쌍둥이자리, 오리온자리, 큰개자리를 관찰할 수 있습니다. 또한 동쪽에서는 봄철 대표적인 별자리를, 서쪽에서는 가을철 대표적인 별자리를 관찰할 수 있습니다.',
    audio: '/sounds/6-1-4/narration/6-1-4-D.MP3',
  },
  fall: {
    text: '가을철(추분경), 자정(밤 12 시경)에 남쪽 하늘을 바라보면 가을철 대표적인 별자리인 안드로메다자리, 페가수스자리, 물고기자리를 관찰할 수 있습니다. 또한 동쪽에서는 겨울철 대표적인 별자리를, 서쪽에서는 여름철 대표적인 별자리를 관찰할 수 있습니다.',
    audio: '/sounds/6-1-4/narration/6-1-4-C.MP3',
  },
  winter: {
    text: '여름철(하지경), 자정(밤 12 시경)에 남쪽 하늘을 바라보면 여름철 대표적인 별자리인 백조자리, 거문고자리, 독수리자리를 관찰할 수 있습니다. 또한 동쪽에서는 가을철 대표적인 별자리를, 서쪽에서는 봄철 대표적인 별자리를 관찰할 수 있습니다.',
    audio: '/sounds/6-1-4/narration/6-1-4-B.MP3',
  },
  spring: {
    text: '봄철(춘분경), 자정(밤 12 시경)에 남쪽 하늘을 바라보면 봄철 대표적인 별자리인 목동자리, 처녀자리, 사자자리를 관찰할 수 있습니다.\n또한 동쪽에서는 여름철 대표적인 별자리를, 서쪽에서는 겨울철 대표적인 별자리를 관찰할 수 있습니다.',
