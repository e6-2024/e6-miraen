...
const activityGuideSlides: ActivityGuideSlide[] = [
  {
    id: 'slide1',
    image: '/img/guide/5-1-3/guide1.jpeg',
    audioPath: '/sounds/5-1-3/intro/5-1-3-Intro-1.MP3',
  },
  {
    id: 'slide2',
    image: '/img/guide/5-1-3/guide2.jpeg',
    audioPath: '/sounds/5-1-3/intro/5-1-3-Intro-2.MP3',
  },
  {
    id: 'slide3',
    image: '/img/guide/5-1-3/guide3.jpeg',
    audioPath: '/sounds/5-1-3/intro/5-1-3-Intro-3-1.MP3',
  },
  {
    id: 'slide4',
    image: '/img/guide/5-1-3/guide4.jpeg',
    audioPath: '/sounds/5-1-3/intro/5-1-3-Intro-4-1.MP3',
  },
  {
    id: 'slide5',
    image: '/img/guide/5-1-3/guide5.jpeg',
    audioPath: '/sounds/5-1-3/intro/5-1-3-Intro-5.MP3',
  },
  {
    id: 'slide6',
    image: '/img/guide/5-1-3/guide6.jpeg',
    audioPath: '/sounds/5-1-3/intro/5-1-3-Intro-6.MP3',
  },
  {
    id: 'slide7',
    image: '/img/guide/5-1-3/guide7.jpeg',
    audioPath: '/sounds/5-1-3/intro/5-1-3-Intro-7.MP3',
  }
]
                ...
                {slides.map((_, index) => (
                  <div
                    ...
                    className={`w-2 h-2 rounded-full mx-2 transition-all duration-300 ${
                      index === currentSlide
                        ? 'bg-[#009BF5] shadow-[0_0_8px_rgba(82,174,170,0.6)] scale-125'
                        : 'bg-gray-300 '
                    }`}
                  />
                ))}
