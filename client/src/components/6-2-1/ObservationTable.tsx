      ...
      <div
        ...
        <CrayonTextBox
          ...
          <table className='text-base w-full border-collapse min-w-[280px]'>
            ...
            <tbody>
              <tr>
                <td className='py-3 px-4 border-2 border-gray-600 text-center bg-sky-100 font-light'>태양 고도</td>
                <td className='border-2 border-gray-600 text-center py-3 px-4 bg-white font-light'>
                  {currentData.altitude}°
                </td>
              </tr>
              <tr>
                <td className='py-3 px-4 border-2 border-gray-600 text-center bg-sky-100 font-light'>그림자 길이</td>
                <td className='border-2 border-gray-600 text-center py-3 px-4 bg-white font-light'>
                  {currentData.shadowLength} cm
                </td>
              </tr>
              <tr>
                <td className='py-3 px-4 border-2 border-gray-600 text-center bg-sky-100 font-light'>기온</td>
