...
const activityGuideSlides: ActivityGuideSlide[] = [
  {
    id: 'slide1',
    image: '/img/guide/6-1-2/guide1.jpeg',
    audioPath: '/sounds/6-1-2/intro/6-1-2-Intro-1.MP3'
  },
  {
    id: 'slide2',
    image: '/img/guide/6-1-2/guide2.jpeg',
    audioPath: '/sounds/6-1-2/intro/6-1-2-Intro-2.MP3'
  },
  {
    id: 'slide3',
    image: '/img/guide/6-1-2/guide3.jpeg',
    audioPath: '/sounds/6-1-2/intro/6-1-2-Intro-3.MP3'
  },
  {
    id: 'slide4',
    image: '/img/guide/6-1-2/guide4.jpeg',
    audioPath: '/sounds/6-1-2/intro/6-1-2-Intro-4.MP3'
  },
  {
    id: 'slide5',
    image: '/img/guide/6-1-2/guide5.jpeg',
    audioPath: '/sounds/6-1-2/intro/6-1-2-Intro-5.MP3'
  },
  {
    id: 'slide6',
    image: '/img/guide/6-1-2/guide6.jpeg',
    audioPath: '/sounds/6-1-2/intro/6-1-2-Intro-6.MP3'
  },
  {
    id: 'slide7',
    image: '/img/guide/6-1-2/guide7.jpeg',
    audioPath: '/sounds/6-1-2/intro/6-1-2-Intro-7.MP3'
  },
  {
    id: 'slide8',
    image: '/img/guide/6-1-2/guide8.jpeg',
    audioPath: '/sounds/6-1-2/intro/6-1-2-Intro-8.MP3'
  },
  {
    id: 'slide9',
    image: '/img/guide/6-1-2/guide9.jpeg',
    audioPath: '/sounds/6-1-2/intro/6-1-2-Intro-9.MP3'
  },
  {
    id: 'slide10',
    image: '/img/guide/6-1-2/guide10.jpeg',
    audioPath: '/sounds/6-1-2/intro/6-1-2-Intro-10.MP3'
  }
]
                ...
                {slides.map((_, index) => (
                  <div
                    ...
                    className={`w-2 h-2 rounded-full mx-2 transition-all duration-300 ${
                      index === currentSlide
                        ? 'bg-[#05A8A4] shadow-[0_0_8px_rgba(82,174,170,0.6)] scale-125'
                        : 'bg-gray-300 '
                    }`}
                  />
                ))}
